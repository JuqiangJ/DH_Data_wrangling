...
## from CSV/TXT
You can import data in csv (comma seperate) or text files that use a different delimiter to seperate data. There two groups of function you can use:
...
readr functions are 10 times faster than basi functions.

* read_csv(): you can specify col_types = list(col_double(), col_character()), or col_names = c("a","b")
* read_delim()
* read_table()
...
R has some basic function that can help us have a quick look at the dataframe import.
...
This gives the information about the types of variables your dataframe contain.

***

Alternatively, you hover your mouse over the head of the table, it will give you basic information about the variable type of the column.
